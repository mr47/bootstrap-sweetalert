// SweetAlert
// 2015 (c) - Tristan Edwards
// add AMD version Dmitry.Poddubniy
// github.com/mr47/bootstrap-sweetalert
(function(root, factory) {
  ...
  var modalClass   = '.sweet-alert',
      ...
      defaultParams = {
        ...
        confirmButtonClass: 'btn-style-6',
        cancelButtonText: 'Cancel',
        cancelButtonClass: 'btn-style-7',
        containerClass: '',
        titleClass: '',
        textClass: '',
        imageUrl: null,
  ...
  window.sweetAlertInitialize = function() {
    var sweetHTML =
            ...
            '<div class="sweet-alert" tabIndex="-1">' +
              ...
              '<p>' +
                '<button class="cancel btn btn-style-6" tabIndex="2">Cancel</button>' +
                '<button class="confirm btn btn-style-6" tabIndex="1">OK</button>' +
              '</p>' +
            '</div>',
  ...
  window.sweetAlert = window.swal = function() {
    ...
    switch (typeof arguments[0]) {
      ...
      case 'object':
        ...
        params.disableKeysActions = arguments[0].disableKeysActions || defaultParams.disableKeysActions;
    ...
    function handleKeyDown(e) {
      ...
      if (keyCode === 9) {
        ...
        if ((keyCode === 13 || keyCode === 32) && !params.disableKeysActions) {
            if (btnIndex === -1) {
      ...
      if (modalIsVisible) {
        ...
        if ($focusElement !== null) {
          ...
          if (btnIndex === -1) {
            ...
            //$targetElement.focus();// dont mix focus with bootstrap open modals
          }
        } else {
